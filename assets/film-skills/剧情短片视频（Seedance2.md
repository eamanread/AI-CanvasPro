# 剧情短片视频（Seedance2.0音色连贯参考）

## Skill 描述

支持两种启动方式：用户上传剧本，或由 agent 根据用户提供的主题/需求代写剧本。随后使用 Nano Banana + Seedance 2.0 生成视频。在关键阶段暂停以供用户确认；基于一镜到底工作流的人机协作。 
...
```json
{
  ...
  "cover_standard_url": {
    "compressed": "https://cdn-ap.flova.tv/skill_covers/skill_cover_1006d1810159451ab98d3abf854a642f_compressed.webp?auth_key=1781839422-0-0-1ceb10b01a5beef8bdc6c798c8a7d7d1",
    "large": "https://cdn-ap.flova.tv/skill_covers/skill_cover_1006d1810159451ab98d3abf854a642f_large.webp?auth_key=1781839422-0-0-91c8651860e32b77e759265d7466043c",
    "medium": "https://cdn-ap.flova.tv/skill_covers/skill_cover_1006d1810159451ab98d3abf854a642f_medium.webp?auth_key=1781839422-0-0-45247e34619f2ae6cd8525d8b8bc1426",
    "small": "https://cdn-ap.flova.tv/skill_covers/skill_cover_1006d1810159451ab98d3abf854a642f_small.webp?auth_key=1781839422-0-0-b30b09c74c60e3870e1e8636a89ac523"
  },
  "created_at": "2026-05-20T03:23:42.120751+00:00",
  "description": "核心亮点：- 角色语音锚定：每个角色在元素阶段都有专属的参考音频，确保整个过程中语调的一致性。- 由 Seedance 2.0驱动 — 省略关键帧步骤，直接从元素图像生成最终镜头。- 循序渐进的人机协作 — 在每个关键阶段进行确认，以保持完全掌控。",
  "enabled": 1,
  "extra_data": null,
  "group_id": "015bc039085b453296fcefee406d24f9",
  "is_draft": 0,
  "is_public": 1,
  "locale": "zh",
  "project_id": null,
  "skill_content": [
    ...
    {
      "config": {},
      "content": "按分镜和时间轴顺序组装所有镜头、旁白音轨和BGM；当剪辑就绪后，引导用户导出。",
      "section": "video_assembler"
    }
  ],
  "skill_description": "支持两种启动方式：用户上传剧本，或由 agent 根据用户提供的主题/需求代写剧本。随后使用 Nano Banana + Seedance 2.0 生成视频。在关键阶段暂停以供用户确认；基于一镜到底工作流的人机协作。 ",
  "skill_id": "5ef6b8ad22b0495e8140ad97abae3572",
  "skill_name": "剧情短片视频（Seedance2.0音色连贯参考）",
  "source": 3,
  "source_skill_id": null,
  "updated_at": "2026-05-20T03:39:25.265638+00:00",
  "user_id": null,
  "version": 2,
  "visible_to_all": true
}
